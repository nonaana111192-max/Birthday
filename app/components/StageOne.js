    ...
    >
      <div className="flex flex-col items-center">
        <motion.div
          ...
          className="w-32 h-32 rounded-full flex items-center justify-center bg-white shadow-inner"
          aria-hidden="true"
        >
        ...
        <p className="text-gray-600 mt-2">Aku buat sesuatu kecil buat kamu — ayo mulai permainan kecilnya 💕</p>
